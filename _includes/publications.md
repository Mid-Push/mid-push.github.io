<div class="publications-header">
  <h2 id="publicationsTitle" style="margin: 0;">Selected Publications</h2>
  <div class="header-right">
    <div class="toggle-container">
      <span>Selected</span>
      <div class="toggle-switch" id="publicationsToggle">
        <div class="toggle-slider"></div>
      </div>
      <span>All</span>
    </div>
    <temp style="font-size:15px;">[</temp>
    <a href="https://scholar.google.com/citations?user=mChB-hQAAAAJ&hl=en&oi=ao" target="_blank" style="font-size:15px;color:#71b07b;">Google Scholar</a>
    <temp style="font-size:15px;">]</temp>
  </div>
</div>
...
<ol class="bibliography">
  ...
  <li class="publication-item selected">
<div class="pub-row">
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a href="https://arxiv.org/pdf/2306.12511.pdf" style="color:#71b07b;">Nonparametric Identification of Latent Concepts </a></div>
...
<div class="pub-row">
  ...
  <li class="publication-item additional" style="display: none;">
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
